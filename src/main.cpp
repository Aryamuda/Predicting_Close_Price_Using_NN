...
void run_main_training_pipeline() {
    ...
    size_t batch_size = 32; // <--- DEFINE BATCH SIZE HERE (e.g., 32, 64, 128)

    std::cout << "\nInitializing Neural Network with:" << std::endl;
    std::cout << "  Learning Rate: " << learning_rate << std::endl;
    std::cout << "  Batch Size: " << batch_size << std::endl; // Print batch size
    ...
    // --- Use NeuralNetwork::train method WITH BATCH_SIZE ---
